                    ...
                    <div class="card-body">
                        <form action="{{route('peminjam.update', $peminjam->id)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="peminjam_kode" id="" value="{{$peminjam->peminjam_kode}}">
                            </div>
                            <div class="form-group">
                                <label for="">nama</label>
                                <input class="form-control" type="text" name="peminjam_nama" id="" value="{{$peminjam->peminjam_nama}}">
                            </div>
                            <div class="form-group">
                                <label for="">alamat</label>
                                <input class="form-control" type="text" name="peminjam_alamat" id="" value="{{$peminjam->peminjam_alamat}}">
                            </div>
                            <div class="form-group">
                                <label for="">telp</label>
                                <input class="form-control" type="text" name="peminjam_telp" id="" value="{{$peminjam->peminjam_telp}}">
                            </div>
                            <div class="form-group">
